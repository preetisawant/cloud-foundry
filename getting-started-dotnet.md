...
<a class="xref" href="https://github.com/IBM-Cloud/get-started-aspnet-core" target="_blank" title="(Download sample code)"><img class="w3-image" src="/docs/cloud-foundry/images/btn_starter-code.svg" alt="Download application code"/></a>{: hide-in-docs}
