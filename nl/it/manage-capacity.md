...
1. Vai al [dashboard {{site.data.keyword.Bluemix_notm}} Cloud Foundry](https://console.bluemix.net/dashboard/cloudfoundry?filter=cf_environments) e apri l'{{site.data.keyword.cfee_full_notm}} in cui vuoi gestire l'utilizzo delle risorse.
