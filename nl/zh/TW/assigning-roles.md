...
您可以將多個角色授與 {{site.data.keyword.Bluemix_notm}} 帳戶中的團隊成員。這些角色定義使用者用來管理帳戶和組織資源的許可權：您可以將[使用者角色](/docs/iam/users_roles.html#userroles)授與組織的成員。這些角色定義在組織內的存取層次，並限制哪些人可以存取空間及其資源。例如，您可以授與使用者不同空間的不同許可權。
