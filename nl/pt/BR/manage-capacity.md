...
1. Acesse o [ painel do {{site.data.keyword.Bluemix_notm}} Cloud Foundry](https://console.bluemix.net/dashboard/cloudfoundry?filter=cf_environments) e abra o {{site.data.keyword.cfee_full_notm}} onde você deseja gerenciar o uso do recurso.
