...
1. Wechseln Sie zum [{{site.data.keyword.Bluemix_notm}} Foundry-Dashboard](https://cloud.ibm.com/dashboard/cloudfoundry?filter=cf_environments) und öffnen Sie die {{site.data.keyword.cfee_full_notm}}-Instanz, in der Sie die Ressourcennutzung verwalten möchten.
