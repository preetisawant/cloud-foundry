...
1. [{{site.data.keyword.Bluemix_notm}} Cloud Foundry ダッシュボード](https://cloud.ibm.com/dashboard/cloudfoundry?filter=cf_environments)に移動し、リソース使用量を管理する {{site.data.keyword.cfee_full_notm}} を開きます。
