...
|----------------------------------------|-------------------|-------------------|
|Create a CFEE |  <ul><li>Viewer role in Resource Group where CFEE is to be created.</li> <li>Editor role in the CFEE service.</li> <li>Administrator role in Kubernetes service.</li> <li>Editor platform role, and manager service access role in the IBM Cloud Object Storage service.</li> </ul> | <ul><li>User role in a public organization.</li> <li>Developer role in a space in that pubic organization. </li></ul>|
