...
* [Additional tooling](/docs/cloud-foundry?topic=cloud-foundry-monitoring) within the in the monitoring toolset allows to continously test important CF APIs.
