...
If you have Administrator role in an IBM Cloud account you can a SoftLayer account to to create the CFEE instance without upgrading the IBM Cloud account.
